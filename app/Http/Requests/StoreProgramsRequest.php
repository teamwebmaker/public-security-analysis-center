...
class StoreProgramsRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            // Image fields
            'image.required' => 'გთხოვთ ატვირთეთ პროგრამის სურათი.',
            ...
            'certificate_image.image' => 'სერტიფიკატის ფაილი უნდა იყოს სურათი.',
            ...
            // Video field
            'video.url' => 'გთხოვთ მიუთითოთ სწორი ვიდეო ბმული.',
            ...
            'hour_start.date_format' => 'არასწორი დაწყების დროის ფორმატი (HH:MM).',
            'hour_end.required' => 'გთხოვთ მიუთითოთ დასრულების დრო.',
            'hour_end.date_format' => 'არასწორი დასრულების დროის ფორმატი (HH:MM).',
