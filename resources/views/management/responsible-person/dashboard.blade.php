	...
	@if ($inProgressTasks->isNotEmpty())
		<div class="my-4">
			...
			<div class="my-3 shadow-sm rounded-3 overflow-hidden ">
				<x-shared.table :items="$inProgressTasks" :headers="['#', 'სტატუსი', 'შემსრულებელი', 'ფილიალი', 'სერვისი', 'დოკუმენტი', 'სამუშაოს დაწყება',]" :rows="$userTableRowsWithoutEndDate" :sortableMap="['სამუშაოს დაწყება' => 'start_date',]" :tooltipColumns="['branch', 'service']" :actions="false" />
			</div>
		</div>
