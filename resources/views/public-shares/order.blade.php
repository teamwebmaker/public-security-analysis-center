                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4 p-md-5">
                        <div class="d-flex align-items-center gap-3 mb-4">
                            ...
                            <div>
                                <div class="text-muted small">გაზიარებული ბრძანების დოკუმენტი</div>
                                <h1 class="h4 mb-0">{{ $order->title }}</h1>
                            </div>
                        </div>

                        <dl class="row mb-4">
                            <dt class="col-sm-3">კომპანია</dt>
                            <dd class="col-sm-9">{{ $order->branch->company?->name }}</dd>
                            <dt class="col-sm-3">ფილიალი</dt>
                            <dd class="col-sm-9">{{ $order->branch->name }}</dd>
                        </dl>
