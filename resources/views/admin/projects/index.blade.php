            ...
            <div class="col-xl-4 col-lg-6 mb-4">
                <div class="card">
                    ...
                    <div class="card-footer d-flex justify-content-between">
                        <a type="button" class="btn btn-success d-flex gap-2" href="{{ route('projects.edit', ['project' => $project]) }}">
                            <i class="bi bi-pencil-square"></i>
                            <span class="text-label">Edit</span>
                        </a>
                        <form method="POST" action="{{ route('projects.destroy', ['project' => $project]) }}" onsubmit="return confirm('წავშალოთ პროექტი?')">
                            @csrf
                            @method('DELETE')
