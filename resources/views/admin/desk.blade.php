    ...
    <div class="col-md-4 mb-3">
        <div class="card bg-warning">
            ...
            <div class="card-body d-flex justify-content-between">
                ...
                <button class="btn btn-info px-2 py-1">{{ $projects -> count }}</button>
            </div>
        </div>
    </div>
     <div class="col-md-4 mb-3">
            <div class="card bg-warning">
                ...
                <div class="card-body d-flex justify-content-between">
                    ...
                    <button class="btn btn-info px-2 py-1">{{ $partners -> count }}</button>
                </div>
            </div>
     </div>
     <div class="col-md-4 mb-3">
            <div class="card bg-warning">
                ...
                <div class="card-body d-flex justify-content-between">
                    ...
                    <button class="btn btn-info px-2 py-1">40</button>
                </div>
            </div>
     </div>
      <div class="col-md-4 mb-3">
            <div class="card bg-warning">
                ...
                <div class="card-body d-flex justify-content-between">
                    ...
                    <button class="btn btn-info px-2 py-1">{{ $publications -> count }}</button>
                </div>
            </div>
      </div>
</div>
