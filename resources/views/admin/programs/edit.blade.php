        ...
        <div class="card shadow-sm border-0">
          ...
          <div class="card-body">
            <form method="POST" action="{{ route('programs.update', $program) }}" enctype="multipart/form-data"
               ...
               <div class="tab-content p-3 border mb-4 rounded">
                 <!-- KA Content -->
                 <div class="tab-pane fade show active" id="ka" role="tabpanel">
                   <div class="mb-3">
                     ...
                     <input type="text" id="title-ka" name="title[ka]"
                        ...
                        placeholder="შეიყვანეთ სათაური ქართულად" value="{{ old('title.ka', $program->title->ka) }}"
                        required>
                     @error('title.ka')
                 ...
                 @enderror
                   ...
                   <div class="mb-3">
                     <label for="description-ka" class="form-label">აღწერა <span class="text-danger">*</span></label>
...
@section('scripts')
   <script type="module" src="{{ asset('scripts/program/programEdit.js') . '?date=' . $modified }}"></script>
@endsection